...
_project_serializer = shelve.serializer.PydanticSerializer(ProjectInfo)  # type: ignore[arg-type]
_task_serializer = shelve.serializer.PydanticSerializer(TaskInfo)  # type: ignore[arg-type]
