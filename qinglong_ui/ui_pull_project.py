...
class Ui_pullProject(object):
    def setupUi(self, pullProject):
        if not pullProject.objectName():
            pullProject.setObjectName(u"pullProject")
        ...
        self.oneFileCheckBox.setObjectName(u"oneFileCheckBox")
    ...
    def retranslateUi(self, pullProject):
        pullProject.setWindowTitle(QCoreApplication.translate("pullProject", u"Dialog", None))
        self.label_4.setText(QCoreApplication.translate("pullProject", u"name", None))
        self.label_3.setText(QCoreApplication.translate("pullProject", u"url", None))
        self.oneFileCheckBox.setText(QCoreApplication.translate("pullProject", u"one_file", None))
        self.cancelButton.setText(QCoreApplication.translate("pullProject", u"cancel", None))
        self.okButton.setText(QCoreApplication.translate("pullProject", u"ok", None))
    # retranslateUi
